...
In this example, the PathPlanner library uses a custom <code>.path</code> extension to move a drive base. All <code>.path</code> files are found under a folder called PathPlanner.
